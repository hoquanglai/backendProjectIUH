...
function initialize() {
    return new Promise((resolve, reject) => {
        ...
        app.use(function (req, res, next) {
            ...
            res.setHeader("Access-Control-Allow-Headers", "Access-Control-Allow-Origin,Access-Control-Allow-Headers, Origin,Accept, X-Requested-With, Content-Type, Access-Control-Request-Method, Access-Control-Request-Headers,Authorization, auth-token");
            next();
        });
